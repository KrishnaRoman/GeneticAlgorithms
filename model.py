...
from keras.layers import ELU, LeakyReLU, ReLU, PReLU
...
def DCUNet(height, width, channels, dropout):
    '''
    DC-UNet
    ...
    drop1 = Dropout(dropout)(dcblock1)
    dcblock1 = ResPath(32, 4, drop1)

    dcblock2 = DCBlock(32*2, pool1)
    pool2 = MaxPooling2D(pool_size=(2, 2))(dcblock2)
    drop2 = Dropout(dropout)(dcblock2)
    dcblock2 = ResPath(32*2, 3, drop2)

    dcblock3 = DCBlock(32*4, pool2)
    pool3 = MaxPooling2D(pool_size=(2, 2))(dcblock3)
    drop3 = Dropout(dropout)(dcblock3)
    dcblock3 = ResPath(32*4, 2, drop3)

    dcblock4 = DCBlock(32*8, pool3)
    pool4 = MaxPooling2D(pool_size=(2, 2))(dcblock4)
    drop4 = Dropout(dropout)(dcblock4)
    dcblock4 = ResPath(32*8, 1, drop4)
