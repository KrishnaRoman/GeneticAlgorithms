...
model = DCUNet(height=96, width=128, channels=3, dropout=0.7069737079961617)

optimizer = Nadam(learning_rate=0.00086056834, beta_1=0.8323237049511515, beta_2=0.8603984771889674)
...
trainStep(model, X_train, Y_train, X_test, Y_test, epochs=100, batchSize=4)
